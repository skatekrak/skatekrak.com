...
// ============================================================================
// Server-side client — for getServerSideProps (no credentials needed)
// ============================================================================
...
export const serverClient: ContractRouterClient<typeof contract> = createORPCClient(serverLink);
