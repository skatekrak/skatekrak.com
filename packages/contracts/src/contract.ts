...
import {
    ...
    searchSpotAddressesInput,
    searchSpotAddressesOutput,
    resolveSpotAddressInput,
    resolveSpotAddressOutput,
    mergeSpotsInput,
    mergeSpotsOutput,
    deleteSpotInput,
    adminListMediaInput,
...
export const contract = {
    ...
    admin: {
        ...
        spots: {
            ...
            searchAddresses: oc.input(searchSpotAddressesInput).output(searchSpotAddressesOutput),
            resolveAddress: oc.input(resolveSpotAddressInput).output(resolveSpotAddressOutput),
