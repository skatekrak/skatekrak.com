...
export const updateSpotLocationInput = z.object({
    id: z.string(),
    latitude: z.number().min(-90).max(90),
    longitude: z.number().min(-180).max(180),
});

export const updateSpotLocationOutput = z.object({
    id: z.string(),
    latitude: z.number(),
    longitude: z.number(),
});
...
export const deleteSpotInput = z.object({
    id: z.string().min(1),
});
...
export const adminDeleteMediaInput = z.object({
    id: z.string().min(1),
});
