...
We try to keep track of what's been done on these spots for a while now! Rewatch skateboarding history on all these familiar spots and add your knowledge or your own footage on the app!
    ...
    },
    {
        ...
        about: `
It all started with one live webcam in Brussels I used to check to see if the floor was dry downtown after it rained. It’s on a spot that is really crowdy all the time so you can actually see if it’s the right time to skate. I found out there was some other plazas, skateparks, or smaller spots worldwide with webcams. Imagine if you could film a part using them!
        `,
        spots: require('data/customMaps/webcam.json'),
    },
    {
        id: 'andrew',
