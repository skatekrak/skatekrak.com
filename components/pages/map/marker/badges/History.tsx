...
export default () => (
    <svg className="map-badge-history map-badge" viewBox="0 0 20 20">
        <circle className="map-badge-history-bg" cx="10" cy="10" r="10" />
        <path
