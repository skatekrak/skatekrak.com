                ...
                <div id="map-legend">
                    ...
                    <div id="map-legend-scroll-container">
                        <p id="map-legend-desc">
                            Skateboarding isn't easy. It takes time, passion, effort & learning. But when you're in the
                            flow, starting to see things all around you differently, it's incredibly thrilling &
                            addictive. That's why we're making this map. There's so much more to come. If you want to be
