...
import ReactMapGL, { GeolocateControl, InteractiveMap, NavigationControl } from 'react-map-gl';
...
class MapContainer extends React.Component<Props, State> {
    ...
    public render() {
        ...
        //     if (this.mapRef.current.props.zoom > this.mapRef.current.props.maxZoom - 2 && cluster.spots.length > 0) {
    ...
    private heatmapSizeAccessor = (cluster: Cluster) => {
        ...
        return Math.max(lngDeg * lngPxPerDeg, latDeg * latPxPerDeg, 40);
    };
